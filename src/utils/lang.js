const LANG = {
  ...
  no_patients_assigned:    { sw: 'Hakuna wagonjwa waliochagua.', en: 'No patients assigned.' },
  no_patients_hint:        { sw: 'Wagonjwa wataonekana hapa wanapotafuta daktari.', en: 'Patients will appear here after they select a doctor.' },
  patient_since:           { sw: 'Tangu', en: 'Patient since' },
  select_patient:          { sw: 'Chagua mgonjwa', en: 'Select patient' },
  selected_patient:        { sw: 'Mgonjwa aliyechaguliwa', en: 'Selected Patient' },
